  ...
  return (
    <div className="flex flex-col justify-center items-center gap-12 p-8 ">
      <div className="flex items-center gap-5">
        ...
        <p className="text-gray-200 text-2xl md:text-4xl font-bold">HireHub</p>
      </div>
      <ul className="flex list-none gap-12 text-gray-200 text-sm md:text-base">
      ...
      <div className="flex flex-col items-center gap-8 w-full mb-8 text-gray-200 text-sm md:text-base">
