  ...
  return (
    <div className=" md: pt-24 md:px-12 lg:px-32">
      <div className=" bg-orange-500 p-12 bg-custom-gradient md:px-24 md:py-24 flex flex-col items-center space-y-8 rounded-2xl">
            ...
            <button className="rounded-full bg-black text-white font-bold py-3 px-6 hover:bg-white hover:text-black hover:border border-black">Get started with HireHub</button>
      </div>
      <Footercomponent/>
    </div>
  )
